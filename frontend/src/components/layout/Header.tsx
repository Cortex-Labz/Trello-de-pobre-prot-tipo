...
export default function Header() {
  ...
  return (
    <header
      className="sticky top-0 z-50 px-6 py-4 flex items-center justify-between shadow-lg border-b"
      style={{
    ...
    >
      ...
      <div className="flex-1 max-w-xl mx-auto px-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 rounded-xl text-sm transition-all focus:outline-none focus:ring-2 focus:ring-blue-500/50"
            style={{
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Add Button */}
        <button
          className="px-4 h-10 rounded-xl flex items-center gap-2 transition-all hover:scale-105 shadow-lg font-medium text-sm text-white"
          style={{
            background: 'linear-gradient(135deg, var(--bg-gradient-start) 0%, var(--bg-gradient-end) 100%)',
          }}
          title="Criar"
